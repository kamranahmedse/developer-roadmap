  ...
  return (
    <PageWrapper>
      ...
      <main>
        ...
        <Box bg="white" as='section' aria-labelledby='video-explanations'>
          <Container maxW="container.md" as='article' id='video-explanations'>
        ...
        <Box pb="80px" bg="white" as='section' aria-labelledby='guides'>
          <Container maxW="container.md" position="relative" id='guides' as='article'>
