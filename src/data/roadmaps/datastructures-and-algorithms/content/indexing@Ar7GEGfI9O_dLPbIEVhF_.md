...
- [@article@Indexing in Databases - GeeksforGeeks](https://www.geeksforgeeks.org/indexing-in-databases-set-1/)
- [@official@Database Index - Wikipedia](https://en.wikipedia.org/wiki/Database_index)
- [@official@MySQL Indexes Documentation](https://dev.mysql.com/doc/refman/8.0/en/mysql-indexes.html)
