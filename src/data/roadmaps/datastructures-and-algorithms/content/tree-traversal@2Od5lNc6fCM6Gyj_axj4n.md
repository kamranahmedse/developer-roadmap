...
- [@article@4 Types of Tree Traversal Algorithms - Built In](https://builtin.com/software-engineering-perspectives/tree-traversal)
- [@article@Breadth-first Search - Wikipedia](https://en.wikipedia.org/wiki/Breadth-first_search)
- [@article@Binary Search - Wikipedia](https://en.wikipedia.org/wiki/Binary_search_algorithm)
