...
- [@article@Pseudocode and Flowchart: Complete Beginner's Guide - Codecademy](https://www.codecademy.com/article/pseudocode-and-flowchart-complete-beginners-guide)
- [@article@Pseudocode: What It Is and How to Write It - Built In](https://builtin.com/data-science/pseudocode)
- [@course@Planning with Pseudo-code - Khan Academy](https://www.khanacademy.org/computing/computer-programming/programming/good-practices/pt/planning-with-pseudo-code)
