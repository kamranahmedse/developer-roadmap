...
- [@article@EXPTIME - Wikipedia](https://en.wikipedia.org/wiki/EXPTIME)
- [@article@Time Complexity of Exponential Recursive Functions](https://www.geeksforgeeks.org/time-complexity-of-exponential-recursive-functions/)
- [@article@Exponential Time - Wikipedia](https://en.wikipedia.org/wiki/Exponential_time)
