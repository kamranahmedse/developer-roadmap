...
- [@article@Minimum Spanning Tree - Wikipedia](https://en.wikipedia.org/wiki/Minimum_spanning_tree)
- [@article@Minimum Spanning Tree - HackerEarth](https://www.hackerearth.com/practice/algorithms/graphs/minimum-spanning-tree/tutorial/)
- [@article@Minimum Spanning Trees - Princeton Algorithms](https://algs4.cs.princeton.edu/43mst/)