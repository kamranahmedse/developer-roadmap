...
- [@article@Introduction to Trie Data Structure](https://www.geeksforgeeks.org/dsa/introduction-to-trie-data-structure-and-algorithm-tutorials/)
- [@article@Trie - Wikipedia](https://en.wikipedia.org/wiki/Trie)
- [@video@Introduction to the Trie Data Structure](https://www.youtube.com/watch?v=CX777rfuZtM)
