...
Notice that we’ve written `blue`, whereas we probably should have written `blue`. We could try to catch that `blue` typo by using a type annotation on palette, but we’d lose the information about each property.
