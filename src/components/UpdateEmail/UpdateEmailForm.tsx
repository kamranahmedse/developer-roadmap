    ...
    <>
      ...
      {!isSubmitted ? (
        <form onSubmit={handleSentVerificationCode} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={isLoading || !newEmail || !newEmail.includes('@')}
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-2">
            <button
              ...
              disabled={isLoading}
              className="inline-flex items-center justify-center rounded-lg bg-black p-2 py-3 text-sm font-medium text-white outline-none focus:ring-2 focus:ring-black focus:ring-offset-1 disabled:bg-gray-400"
            >
