  ...
  return (
    <div className="col-span-2">
      ...
      <div className="mt-3 grid grid-cols-2 gap-2">
        ...
        <button
          className="flex h-7 items-center justify-center whitespace-nowrap rounded border border-gray-300 bg-gray-50 px-2 text-xs font-medium leading-none cursor-pointer hover:opacity-75"
