            ...
            <section key={block.title} className="relative">
              <div className="relative">
                ...
                <div className="relative mt-6">
                  <div className="rounded-3xl border-2 border-black bg-white/95 px-6 py-8 shadow-[0_10px_0_0_rgba(0,0,0,0.06)]">
                      ...
                      {Array.from({ length: rowCount }).map((_, rowIndex) => {
                        ...
                        return (
                          <div
                            ...
                            className="relative grid grid-cols-1 gap-6 lg:grid-cols-[minmax(0,1fr),340px,minmax(0,1fr)] lg:items-center"
                          >
                            <div className="relative flex lg:justify-end">
                              {left ? (
                                <>
                                  <div className="pointer-events-none absolute right-0 top-1/2 hidden h-px w-24 -translate-y-1/2 border-t-2 border-dotted border-blue-500 lg:block" />
                                  ...
                                  <a
                                    ...
                                    className="block w-full max-w-[520px] rounded-2xl border-2 border-black bg-[#ffe39a] px-5 py-4 text-slate-900 shadow-[0_6px_0_0_rgba(0,0,0,0.08)] transition hover:-translate-y-0.5 hover:bg-[#ffefb6]"
                                  >
                                ...
                                <div className="hidden lg:block h-16 w-full max-w-[520px]" />
                              )}
                            </div>
                            ...
                            <div className="relative flex lg:justify-start">
                              {right ? (
                                <>
                                  <div className="pointer-events-none absolute left-0 top-1/2 hidden h-px w-24 -translate-y-1/2 border-t-2 border-dotted border-blue-500 lg:block" />
